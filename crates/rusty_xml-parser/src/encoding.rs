...
const NAME_MAP: &[(&str, XmlCharEncoding)] = &[
    ...
    ("windows-1250", XmlCharEncoding::Windows1250),
    ("cp1250", XmlCharEncoding::Windows1250),
    ("windows1250", XmlCharEncoding::Windows1250),
    ("windows-1251", XmlCharEncoding::Windows1251),
    ("cp1251", XmlCharEncoding::Windows1251),
    ("windows1251", XmlCharEncoding::Windows1251),
    ("windows-1253", XmlCharEncoding::Windows1253),
    ("cp1253", XmlCharEncoding::Windows1253),
    ("windows1253", XmlCharEncoding::Windows1253),
    ("windows-1254", XmlCharEncoding::Windows1254),
    ("cp1254", XmlCharEncoding::Windows1254),
    ("windows1254", XmlCharEncoding::Windows1254),
    ("windows-1255", XmlCharEncoding::Windows1255),
    ("cp1255", XmlCharEncoding::Windows1255),
    ("windows1255", XmlCharEncoding::Windows1255),
    ("windows-1256", XmlCharEncoding::Windows1256),
    ("cp1256", XmlCharEncoding::Windows1256),
    ("windows1256", XmlCharEncoding::Windows1256),
    ("windows-1257", XmlCharEncoding::Windows1257),
    ("cp1257", XmlCharEncoding::Windows1257),
    ("windows1257", XmlCharEncoding::Windows1257),
    ("windows-1258", XmlCharEncoding::Windows1258),
    ("cp1258", XmlCharEncoding::Windows1258),
    ("windows1258", XmlCharEncoding::Windows1258),
    ("koi8-r", XmlCharEncoding::Koi8R),
    ("koi8r", XmlCharEncoding::Koi8R),
    ("cskoi8r", XmlCharEncoding::Koi8R),
    ("koi8-u", XmlCharEncoding::Koi8U),
    ("koi8u", XmlCharEncoding::Koi8U),
    ("ibm866", XmlCharEncoding::Ibm866),
    ("cp866", XmlCharEncoding::Ibm866),
    ("866", XmlCharEncoding::Ibm866),
    ("macintosh", XmlCharEncoding::Macintosh),
    ("mac", XmlCharEncoding::Macintosh),
    ("csmacintosh", XmlCharEncoding::Macintosh),
...
pub fn xml_get_char_encoding_name(enc: XmlCharEncoding) -> Option<&'static str> {
    Some(match enc {
        ...
        XmlCharEncoding::Windows1250 => "windows-1250",
        XmlCharEncoding::Windows1251 => "windows-1251",
        XmlCharEncoding::Windows1253 => "windows-1253",
        XmlCharEncoding::Windows1254 => "windows-1254",
        XmlCharEncoding::Windows1255 => "windows-1255",
        XmlCharEncoding::Windows1256 => "windows-1256",
        XmlCharEncoding::Windows1257 => "windows-1257",
        XmlCharEncoding::Windows1258 => "windows-1258",
        XmlCharEncoding::Koi8R => "KOI8-R",
        XmlCharEncoding::Koi8U => "KOI8-U",
        XmlCharEncoding::Ibm866 => "IBM866",
        XmlCharEncoding::Macintosh => "macintosh",
...
fn table_for(enc: XmlCharEncoding) -> Option<&'static [u16; 128]> {
    Some(match enc {
        ...
        XmlCharEncoding::Windows1250 => &crate::encoding_tables_more::XML_UNICODE_WINDOWS1250,
        XmlCharEncoding::Windows1251 => &crate::encoding_tables_more::XML_UNICODE_WINDOWS1251,
        XmlCharEncoding::Windows1253 => &crate::encoding_tables_more::XML_UNICODE_WINDOWS1253,
        XmlCharEncoding::Windows1254 => &crate::encoding_tables_more::XML_UNICODE_WINDOWS1254,
        XmlCharEncoding::Windows1255 => &crate::encoding_tables_more::XML_UNICODE_WINDOWS1255,
        XmlCharEncoding::Windows1256 => &crate::encoding_tables_more::XML_UNICODE_WINDOWS1256,
        XmlCharEncoding::Windows1257 => &crate::encoding_tables_more::XML_UNICODE_WINDOWS1257,
        XmlCharEncoding::Windows1258 => &crate::encoding_tables_more::XML_UNICODE_WINDOWS1258,
        XmlCharEncoding::Koi8R => &crate::encoding_tables_more::XML_UNICODE_KOI8R,
        XmlCharEncoding::Koi8U => &crate::encoding_tables_more::XML_UNICODE_KOI8U,
        XmlCharEncoding::Ibm866 => &crate::encoding_tables_more::XML_UNICODE_IBM866,
        XmlCharEncoding::Macintosh => &crate::encoding_tables_more::XML_UNICODE_MACINTOSH,
